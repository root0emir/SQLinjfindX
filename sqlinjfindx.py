...
def show_banner(stdscr):
 ...
 _____  _____  _      _           _ ______  _             _ __   __
/  ___||  _  || |    (_)         (_)|  ___|(_)           | |\ \ / /
\ `--. | | | || |     _  _ __     _ | |_    _  _ __    __| | \ V / 
 `--. \| | | || |    | || '_ \   | ||  _|  | || '_ \  / _` | /   \ 
/\__/ /\ \/' /| |____| || | | |  | || |    | || | | || (_| |/ /^\ \
\____/  \_/\_\\_____/|_||_| |_|  | |\_|    |_||_| |_| \__,_|\/   \/
                                _/ |                               
                               |__/                                
...
class SQLiTool:
    ...
    def get_url(self):
        ...
        curses.echo()  
        url = self.stdscr.getstr(3, 2).decode('utf-8')  
        curses.noecho()  
        return url
    ...
    def blind_sqli(self):
        ...
        true_response = requests.get(self.url + true_payload)  
        false_response = requests.get(self.url + false_payload)  
